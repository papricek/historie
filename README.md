...
- `obyvatele_zahradky_domy.md` — hlavní jmenný registr celé vsi podle čísel popisných; obsahuje úplné sčítání 1921, index narozených 1788–1796, úplný domovní inventář snímků 80–117 knihy 6620 (1797–1843) a navazující průchod knihou 6621 na snímcích 309–322
- `obyvatele_zahradky_domy/dolozene_pobyty.md` — generovaný průřez po domech; u každé osoby uvádí datum nebo mezní data nalezených dokladů (1 427 dokladových řádků v 26 domech)
- `obyvatele_zahradky_domy/n11.md` — generovaný domovní pohled na 205 bezpečných osobních řádků N11 / čp. 11 a tři adresně sporné řádky N11/N14
