...
- `obyvatele_zahradky_domy/dolozene_pobyty.md` — generovaný průřez po domech; u každé osoby uvádí datum nebo mezní data nalezených dokladů (1 890 dokladových řádků v 26 domech)
- `obyvatele_zahradky_domy/n11.md` — generovaný domovní pohled na 225 bezpečných osobních řádků N11 / čp. 11 a tři adresně sporné řádky N11/N14
