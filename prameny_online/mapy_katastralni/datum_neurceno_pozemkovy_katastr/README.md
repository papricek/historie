...
[Produktová metadata ČÚZK](https://geoportal.cuzk.gov.cz/Default.aspx?head_tab=sekce-02-gp&menu=2925&metadataID=CZ-CUZK-PK-R&mode=TextMeta&side=dSady_archiv) uvádějí, že mapy bývalého pozemkového katastru byly od katastrálních pracovišť převzaty do ÚAZK v letech 2021–2022, zatím nejsou archivně zpracované a zpřístupňují se po celých katastrálních územích podle předávacích seznamů. Současná aplikace [Archiv ČÚZK](https://ags.cuzk.gov.cz/archiv/) navíc u této vrstvy výslovně upozorňuje, že **datace listů použitých pro vytvoření souvislé vrstvy se nedochovala**. Veřejná mapová služba u tohoto výřezu neukazuje signaturu ani datum jednotlivého rastru.
